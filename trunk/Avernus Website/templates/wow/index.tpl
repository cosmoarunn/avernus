...
<!-- End Content Upside --> 
	...
	<li id="current" class="item40"><a href="{$path}/index.php/account/create">Create Account</a></li>
      <li class="item41"><a href="{$path}/index.php/account/login">Login</a></li>
	    <li class="item41">  <a href="{$path}/index.php/account/">Manage Account</a></li>
	    <li class="item41">  <a href="{$path}/index.php/bugtracker">Bug Tracker</a></li>
	
	<li class="item41"><a href="{$path}/index.php/account/lost"><span>Account Lost?</span></a></li>
											</ul></div> 
				</div> 
			</div> 
		</div> 
			...
			<div> 
				<div> 
					<div> 
											...
											<li class="item41"><a href="{$path}forum.avernuz.com">Forum</a></li>
			...
			<div> 
				<div> 
					<div> 
											...
											<li class="item41"><a href="{$path}/index.php/p/v/gifts"><span>Donation Shop</span></a></li>
				<li class="item41"><a href="{$path}/index.php/p/v/gifts2/history"><span>Transaction History</span></a></li>
											<li class="item41"><a href="{$path}/index.php/p/v/gifts2/donate"><blink><span>Donate</span></a></li></blink>
											<li class="item41"><a href="{$path}/index.php/p/v/gifts2/donate/history"><span>Donate History</span></a></li>
